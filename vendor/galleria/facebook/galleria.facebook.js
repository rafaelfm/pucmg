...
Galleria.Facebook = function( api_key ) {
    ...
    this.options = {
        ...
        facebook_access_token: '1239256162797226|yGdHL3rmGFuJoa6GY580nW1k3YU'      // access token required as of June 2015 to view public photo albums
    };
};
...
Galleria.Facebook.prototype = {
    ...
    */
	...
	//var url = 'https://graph.facebook.com/' + FACEBOOK_API_VERSION + '/' + params['album_id'] + '?callback=?' + '&fields=photos.limit(' + this.options.max + '){images,source,picture,link,name}&access_token=' + this.options.facebook_access_token
        var url = 'https://graph.facebook.com/' + params['album_id'] + '?callback=?' + '&fields=photos.fields(images,source,picture,link,name)&access_token='+this.options.facebook_access_token;
        //var url = 'https://graph.facebook.com/' + params['album_id'] + '?callback=?' + '&fields=photos.fields(images,source,picture,link,name)&access_token=1239256162797226|yGdHL3rmGFuJoa6GY580nW1k3YU';
        var scope = this;
